        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">TiendaSaaS</h1>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              La plataforma más fácil para crear y gestionar tu tienda online. 
              Sin complicaciones, sin costos ocultos. Solo resultados.
            </p>
            ...
            <div className="mt-10">
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Configuración Rápida</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Crea tu tienda en menos de 5 minutos. Sin conocimientos técnicos requeridos.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Pagos Seguros</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Integración con Stripe para pagos seguros y confiables.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Analytics en Tiempo Real</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Monitorea tus ventas y el comportamiento de tus clientes.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Soporte 24/7</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-base text-gray-400">
              &copy; 2024 TiendaSaaS. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
